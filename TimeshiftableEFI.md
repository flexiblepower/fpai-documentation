...
Attribute | Description
--- | ---
id | Unique id to identify the sequential profile.
...
With a SequentialProfileAllocatin a SequentialProfile can be allocated, therefore it contains a start time and the id of the allocated profile.
