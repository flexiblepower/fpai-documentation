...
This bundle contains some plugins for the Felix Web console. This is a useful tool for FPAI developers. This contains the implementation of the Connection Manager plugin.
