...
![AllocationStatus state diagram](RAI-StateDiagram-Allocations.png)
...
![Overview of the revoke classes](RAI-ClassDiagram-Revoke.png)
...
![Commodity class diagram](RAI-ClassDiagram-Commodity.png)
...
![Example of a commodity profile](RAI-Example-CommodityProfile.png)


![Overview of CommodityProfile classes](RAI-ClassDiagram-CommodityProfile.png)
...
![Overview of the commodity forecast classes](RAI-ClassDiagram-CommodityForecast.png)
